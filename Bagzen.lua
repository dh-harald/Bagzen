            ...
            args = {
                ...
                scale = {
                    ...
                    set = function(info, val)
                        ...
                        -- local xOfs = Bagzen.settings.char.bagframe.xOfs
                        -- local yOfs = Bagzen.settings.char.bagframe.yOfs
...
function GameTooltip.SetBagItem(self, container, slot)
    if not container or not slot then
        BagzenSetBagItem(self, container, slot)
    end
    ...
    if itemLink then
        ...
        Bagzen.Tooltip.itemLink = itemlink
    else
        Bagzen.Tooltip.itemID = nil
        Bagzen.Tooltip.itemLink = nil
    end
